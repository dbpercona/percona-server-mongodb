...
def set_globals(options, tests):
    ...
    global no_journal, set_parameters, set_parameters_mongos, mongod_add_options, no_preallocj, storage_engine, wiredtiger_engine_config_string, wiredtiger_collection_config_string, wiredtiger_index_config_string
...
def main():
    ...
    global no_journal, set_parameters, set_parameters_mongos, mongod_add_options, no_preallocj, auth, storage_engine, wiredtiger_engine_config_string, wiredtiger_collection_config_string, wiredtiger_index_config_string
